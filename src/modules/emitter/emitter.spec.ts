...
describe('Emitter', () => {
    let store: HistoryStore & Emitter;
    const StoreWithBackup = Utils.mixin(HistoryStore, [Emitter]);
    ...
    describe('should produce snapshot', () => {
        xit('should produce snapshot of value base-store and namespace base-store', () => {
